    ...
    <>
      ...
      <div className='portfolio'>
        ...
        <div className="flex justify-around hover:justify-evenly">
          <img className="pointer-events-none focus:pointer-events-auto" draggable="false" loading="lazy" src="/logo.png" width="120" height="120"></img>
        </div>
        <br />
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-3">
          {filteredData.map((item: Item, index: number) => (
            <div key={index} className="w-full">
              <Link href={item.readMoreLink} target="_blank" rel="noopener noreferrer">
                <div className="overflow-hidden border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
                  <img className="relative object-cover w-full h-48 overflow-hidden md:h-60" loading="lazy" src={item.image} alt={item.altText} />
                  <div className="p-4">
                    <div>
