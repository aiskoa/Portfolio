...
const Box: React.FC<PropsWithChildren<BoxType>> = ({ title, icons }: PropsWithChildren<BoxType>): ReactElement => {
  return (
    <div className="p-2 m-5 text-4xl font-thin border-2 border-gray-900 flex-column rounded-2xl dark:hover:border-violet-700 hover:border-yellow-500 dark:border-white dark:text-white">
